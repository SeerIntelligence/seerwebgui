// TODO: MOVE CONSTANTS TO CONSTANT.TS FILE
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">
                Protect your services before they even hit production
              </p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">
                Automating the process of security scanning on each release,
                integrating it in the CICD pipeline
              </p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">
                We look for your data and check if there have been any leaks on
                social media or black markets
              </p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">
                We can repair the flaws of your systems, making them secure for
                production
              </p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">
                We can implement essential security practices that are necessary
                to having a secure company
              </p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">
                We can host presentations, classes and drills to teach employees
                of the risks and the common social engineering attack patterns
              </p>
            </div>
          </div>
        </div>
